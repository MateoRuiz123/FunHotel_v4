                ...
                <form id="edit-form" action="{{ route('clientes.update', $cliente->id) }}" method="post"
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="email" placeholder="Correo" class="form-control"
                                        id="validationCustomUsername" name="correo" aria-describedby="inputGroupPrepend"
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" onclick="mostrarAlerta()">Actualizar</button>
                        </div>
                </form>
            </div>
        </div>
